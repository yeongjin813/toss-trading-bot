...
from top3_strategy import load_top3_state
...
def _build_cycle_deps() -> WatchlistCycleDeps:
    return WatchlistCycleDeps(
        ...
        secondary_benchmark_ticker=SECONDARY_BENCHMARK_TICKER,
        capital_at_risk=CAPITAL_AT_RISK,
        overdeployment_trim_enabled=OVERDEPLOYMENT_TRIM_ENABLED,
        overdeployment_trim_target_pct=OVERDEPLOYMENT_TRIM_TARGET_PCT,
        fill_monitor=FILL_MONITOR,
        trade_log=TRADE_LOG,
        process_ticker=process_ticker,
        process_order_retry_queue=process_order_retry_queue,
        run_session_reconciliation=run_session_reconciliation,
        refresh_ledger_deployable_cash=_refresh_ledger_deployable_cash,
        watchlist_mark_prices=_watchlist_mark_prices,
        estimate_portfolio_equity=_estimate_portfolio_equity,
        execute_broker_order=execute_broker_order,
        dispatch_system_alert=_dispatch_system_alert,
        is_auth_failure=_is_auth_failure,
        telegram_enabled=_telegram_enabled,
        run_telegram=_run_telegram,
        send_system_alert=send_system_alert,
    )


CYCLE_DEPS = _build_cycle_deps()
