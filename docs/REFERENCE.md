# Technical Reference (Legacy README)

> **Archived full documentation.** The repo landing page is now [README.md](../README.md).  
> Use [STRATEGY.md](STRATEGY.md), [RISK.md](RISK.md), and [RESEARCH_LOG.md](RESEARCH_LOG.md) for curated summaries.
...
| **8.6** | Regressions caught only manually | GitHub Actions runs `pytest` on push/PR | `.github/workflows/ci.yml` |
